...
## Pipeline Completion Gate (HARD CHECK)

> **BLOCKING RULE (prevents LESSON-08 regression):**
> The pipeline is NOT complete until ALL of these artifacts exist.
> Do NOT proceed to "Final Steps" if any is missing.

```
REQUIRED = [
  "docs/features/<feature>/01_specification.md",   # Phase 1
  "docs/features/<feature>/02_pseudocode.md",       # Phase 1
  "docs/features/<feature>/03_architecture.md",     # Phase 1
  "docs/features/<feature>/04_refinement.md",       # Phase 1
  "docs/features/<feature>/05_completion.md",       # Phase 1
  "docs/features/<feature>/validation-report.md",   # Phase 2
  "docs/features/<feature>/review-report.md"        # Phase 4
]

for artifact in REQUIRED:
  if not fileExists(artifact):
    HALT with: "PIPELINE INCOMPLETE: {artifact} missing. Cannot finalize."
```

> **WHY:** In LESSON-08, /run executed only Phase 3 (IMPLEMENT) for 13 features,
> skipping PLAN, VALIDATE, and REVIEW. This produced code without documentation,
> security review, or validation. Phase 4 was "forgotten" even after explicit reminders.
> This gate makes skipping physically impossible — no artifacts = no completion.
