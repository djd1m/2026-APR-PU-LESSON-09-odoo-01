...
> **HARD CHECK (prevents LESSON-08 regression):**
> Before marking ANY feature as done, verify ALL pipeline artifacts exist:

```
REQUIRED_ARTIFACTS = [
  "docs/features/<id>/01_specification.md",   # Phase 1 proof
  "docs/features/<id>/validation-report.md",  # Phase 2 proof
  "docs/features/<id>/review-report.md"       # Phase 4 proof
]

for artifact in REQUIRED_ARTIFACTS:
  if not fileExists(artifact):
    HALT — "Pipeline incomplete: missing {artifact}. Feature NOT done."
```
